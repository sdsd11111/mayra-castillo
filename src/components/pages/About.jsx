                ...
                <div className="flex-none w-5/6 sm:w-2/3 pl-4 snap-center">
                  <Card className="h-full">
                    <CardContent className="p-8 h-full">
                      ...
                      <h3 className="text-xl font-semibold mb-4 text-center">Experiencia</h3>
                ...
                <div className="flex-none w-5/6 sm:w-2/3 pl-4 snap-center">
                  <Card className="h-full">
                    <CardContent className="p-8 h-full">
                      ...
                      <h3 className="text-xl font-semibold mb-4 text-center">Compromiso</h3>
                      <p className="text-gray-600 text-center">
                ...
                <div className="flex-none w-5/6 sm:w-2/3 pl-4 snap-center">
                  <Card className="h-full">
                    <CardContent className="p-8 h-full">
                      ...
                      <h3 className="text-xl font-semibold mb-4 text-center">Confianza</h3>
                      <p className="text-gray-600 text-center">
